    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="<?= Yii::getAlias('@web')?>/img/usuario.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="<?= Yii::getAlias('@web')?>/img/usuario.jpg" class="user-image img-circle elevation-2" alt="User Image">
                <span class="d-none d-md-inline">Natália Lima</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <!-- User image -->
                <li class="user-header bg-primary">
                    <img src="<?= Yii::getAlias('@web')?>/img/usuario.jpg" class="img-circle elevation-2" alt="User Image">

                    <p>
                        Natália Lima - Web Developer
                        <small>CIO - All Infortec</small>
                    </p>
                </li>
                <!-- Menu Body -->
                <li class="user-body">
